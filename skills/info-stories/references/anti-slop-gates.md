...
- **Throat-clearing:** setup such as "here's the thing" before the actual point
- **Binary contrast:** formulaic "not X, it's Y" framing used as a substitute for evidence
