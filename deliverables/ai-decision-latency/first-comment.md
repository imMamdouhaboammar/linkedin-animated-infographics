A note on what is and is not in the graphic.

The three example outputs in the middle panel ("creative fatigue is increasing", "brand search demand is rising", "campaign B deserves another test") are illustrative. They are labelled as examples on the artboard because they are not results from a real account, and a conceptual example presented as a finding is how a useful post turns into a misleading one.
