...
Version 3.4.0 ships two host adapters with shared quality intent and host-specific execution packaging.
...
The 3.4.0 OpenAI package is prepared as a skills-only update. Tracked reviewer materials live in `submission/`.
...
The 3.4.0 release must agree across:
