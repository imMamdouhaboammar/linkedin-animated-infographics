# Design and OpenAI Plugin Quality v3.7 Specification
...
This is a backwards-compatible public behavior improvement and uses version `3.7.0`.

All host manifests, compatibility registries, marketplace metadata, tests, README/version references, and submission metadata that are release-coupled must agree on `3.7.0`.
