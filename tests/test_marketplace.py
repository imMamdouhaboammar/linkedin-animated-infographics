...
class MarketplaceTests(unittest.TestCase):
    def test_same_repo_marketplace_manifest(self):
        ...
        self.assertEqual("3.6.0", entry["version"])
    ...
    def test_all_host_packages_share_release_version(self):
        ...
        self.assertEqual("3.6.0", claude["version"])
    ...
    def test_readme_documents_both_install_surfaces(self):
        ...
        for needle in ("mamdouh-creative-tools", "linkedin-animated-infographics", "docs/codex.md", "3.6.0"):
